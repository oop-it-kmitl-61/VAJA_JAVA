...
/**
 * this class is door house it is different for
 * any object because player can use it to teleport
 * in anoter map(in house) and add it animation
 */
public class Door extends WorldObj{
