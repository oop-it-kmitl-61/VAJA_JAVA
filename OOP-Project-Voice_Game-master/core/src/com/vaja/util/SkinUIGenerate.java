...
public class SkinUIGenerate {

    public static Skin generateSkin(AssetManager asset){
        Skin skin = new Skin();
        /**
         * check if asset can't load
         */
        if (!asset.isLoaded("res/graphics_packed/ui/uipack.atlas")) {
            throw new GdxRuntimeException("uipack.atlas was not loaded");
        }

        TextureAtlas uiAtlas = asset.get("res/graphics_packed/ui/uipack.atlas");
        ...
        BitmapFont smallFont = asset.get("res/font/small_letters_font.fnt", BitmapFont.class);
